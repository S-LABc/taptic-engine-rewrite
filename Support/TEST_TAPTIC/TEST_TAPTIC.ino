...
#include <Wire.h>
#define DEV_ADDR 0x50 //адрес микросхемы на шине I2C
#define EMPTY_BYTE 0x02 //байт-пустышка (может быть любым)
#define START_BYTE 0 //начальный адрес памяти
#define END_BYTE 50 //конечный адрес памяти
#define IIC_CLOCK 100000 //частота шины I2C
#define SERIAL_BAUDRATE 115200 //скарость связи по Serial
